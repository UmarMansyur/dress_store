    ...
    public partial class Penjualan : Form
    {
        ...
        private void keranjang_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                int amount = Convert.ToInt32(jumlah.Text);
        ...
        private void simpan_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                foreach (DataGridViewRow row in dataGridView2.Rows)
                {
                    ...
                    int id_baju =
                        Convert
                            .ToInt32(Koneksi
                                ...
                                .Rows[0]["id_baju"]);
                    command =
                        "INSERT INTO transaksi (id_baju, id_karyawan, id_pelanggan, tanggal) VALUES (" +
                        id_baju +
                        ", " +
                        id_karyawan +
                        ", " +
                    ...
                    command =
                        "INSERT INTO pembayaran (id_transaksi, tanggal, total) VALUES (" +
                        id_transaksi +
                        ", '" +
                        DateTime.Now.ToString("yyyy-MM-dd") +
                        "', " +
